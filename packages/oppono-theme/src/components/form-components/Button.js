...
const Button = React.forwardRef(({className, label, href, icon = false, onClick, focusable = true}, forwardedRef) => {
  return (
    <button tabIndex={focusable ? null : -1} className={`oppono-btn ${className}`} type={'button'} onClick={onClick}>
