          ...
          <div className="footer-left">
            <div className="guid select">
              ...
              <svg viewBox="0 0 63 20">
                ...
                <path fill="none" stroke="#b5d2ff" strokeMiterlimit="20" strokeOpacity=".4"
            ...
            <div className="guid nav">
              ...
              <svg viewBox="0 0 54 20">
                <path fill="#b5d2ff" d="M8.194 10.81l3.09 3.1.72-.75-1.83-1.8h5.58v-1.07h-5.6l1.85-1.81-.72-.77z"/>
                <path fill="none" stroke="#b5d2ff" strokeMiterlimit="20" strokeOpacity=".4"
                      d="M2.124 19a1.5 1.5 0 0 1-1.5-1.5v-15a1.5 1.5 0 0 1 1.5-1.5h20a1.5 1.5 0 0 1 1.5 1.5v15a1.5 1.5 0 0 1-1.5 1.5z"/>
                <path fill="#b5d2ff" d="M41.954 7.71l-.72.77 1.84 1.81h-5.6v1.07h5.57l-1.81 1.8.72.75 3.08-3.1z"/>
                <path fill="none" stroke="#b5d2ff" strokeMiterlimit="20" strokeOpacity=".4"
