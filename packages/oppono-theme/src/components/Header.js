...
const LogoLink = connect(({state}) => state.theme.user.logged
    ?
    <Link href={'/dashboard'}>
        <svg className={'logo'} viewBox="0 0 4302.4 813">
            <path
                d="M998.2,502.9c0-144.9,111.9-252,263.8-252c151.8,0,263.8,106.4,263.8,252s-111.9,252-263.8,252   C1110.1,754.9,998.2,647.8,998.2,502.9 M1434,502.9c0-100.1-73.5-172.2-172.1-172.2c-98.7,0-172.1,72.1-172.1,172.2   s73.5,172.2,172.1,172.2C1360.6,675.1,1434,603,1434,502.9"/>
            <path
                d="M2032.2,432.2c0,107.8-79.8,174.3-208.5,174.3h-110.5v141.4h-91v-490h201.5   C1952.5,257.9,2032.2,323.7,2032.2,432.2 M1940.6,432.2c0-61.6-41.3-97.3-121-97.3h-106.3v194.6h106.3   C1899.3,529.5,1940.6,493.8,1940.6,432.2"/>
            <path
                d="M2533.2,432.2c0,107.8-79.8,174.3-208.5,174.3h-110.5v141.4h-91v-490h201.5   C2453.4,257.9,2533.2,323.7,2533.2,432.2 M2441.5,432.2c0-61.6-41.3-97.3-121-97.3h-106.3v194.6h106.3   C2400.3,529.5,2441.5,493.8,2441.5,432.2"/>
            <path
                d="M2596.2,502.9c0-144.9,111.9-252,263.8-252c151.8,0,263.8,106.4,263.8,252s-111.9,252-263.8,252   C2708.1,754.9,2596.2,647.8,2596.2,502.9 M3032.1,502.9c0-100.1-73.5-172.2-172.1-172.2c-98.7,0-172.1,72.1-172.1,172.2   s73.5,172.2,172.1,172.2C2958.6,675.1,3032.1,603,3032.1,502.9"/>
            ...
            <path
                d="M3752,502.9c0-144.9,111.9-252,263.8-252c151.8,0,263.8,106.4,263.8,252s-111.9,252-263.8,252   C3863.9,754.9,3752,647.8,3752,502.9 M4187.9,502.9c0-100.1-73.5-172.2-172.1-172.2c-98.7,0-172.1,72.1-172.1,172.2   s73.5,172.2,172.1,172.2C4114.4,675.1,4187.9,603,4187.9,502.9"/>
            <path fill={'#EEEEEE'}
            ...
            <path fill={'#FCFCFC'} d="M16.1,812.9c0.4-2.5,2.3-2,3.9-2c15.8,0,31.5,0,47.3,0c1.6,0,3.5-0.5,3.8,2H16.1z"/>
            <path fill={'#FCFCFC'} d="M0.1,809.9c1.9,0.1,2.9,1.1,3,3C0.6,813.4-0.4,812.4,0.1,809.9"/>
            <path fill={'#FEFEFE'} d="M814.9,812.9c0.1-2,1.5-2,3-2C818.5,814,816.2,812.6,814.9,812.9"/>
        </svg>
            ...
            <Container>
                <div className="menu-content">
                    ...
                    <div className="menu-right">
                        <RightPart/>
                        <div onClick={() => menuHandler(true)} className={'three-dots'}><span className={'primary-bg'}/>
                            <span className={'primary-bg'}/> <span className={'primary-bg'}/></div>
                    </div>
                </div>
            ...
            <div className={classnames('floating-menu', {menuOpened})}>
                <Container>
                    ...
                    <div className="links">
                        ...
                        <Link onClick={() => menuHandler(false)} className={'primary'} href={'/products/'}>Products &
                            Rates</Link>
                        <Link onClick={() => menuHandler(false)} className={'primary'} href={'/map/'}>Lending
                            Areas</Link>
                        <Link onClick={() => menuHandler(false)} className={'primary'} href="/what-we-do/">What We
                            Do</Link>
                        <Link onClick={() => menuHandler(false)} className={'primary'} href={'/get-in-touch/'}>Get in
                            Touch</Link>
                        <Link onClick={() => menuHandler(false)} className={'primary member-login'} href={'/sign-in/'}>Member
                            Login</Link>
                    </div>
                </Container>
            </div>
