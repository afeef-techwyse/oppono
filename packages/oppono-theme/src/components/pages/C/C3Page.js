  ...
  return <div className={className}>
    ...
    <path fill="none" stroke="#bfb6b4" strokeWidth="2" strokeMiterlimit="20" d="M8.299 15.976v0L1 8.678C3.846 5.827 5.452 4.23 8.299 1.379"/>
      ...
      <FormStep pageName={pageName} activeTheme={formData.section_7?.section_theme} stepName={formData.section_7?.section_name}>
        ...
        <div className="form-text-wrapper">
          <h1 className={'form-headline-1'}>{formData.section_7?.qualify_for}</h1>
          <div className={'biggest-number'}><p><sup>$</sup>{+section1Values('home_value') - (+section5Values('mortgage_value_1') || 0)}</p></div>
        </div>
        
        <FormConditionalInput name={'confirm_qualify_amount'} showOn={'no'} checked={'yes'}{...formData.section_7?.amount_like_yes_no}>
      ...
      <FormStep pageName={pageName} activeTheme={formData.section_8?.section_theme} stepName={formData.section_8?.section_name}>
        <div className="form-text-wrapper wide-text">
          ...
          <h2 className={'form-headline-2'}>{formData.section_8?.subtitle}</h2>
        ...
        <Finalize>
          ...
          <Bottom>
            {media !== 'mobile'
              ? <FinalizeChild order={1}>
                <P.D>Your HELOC request is for ${+section7Values('amount_wanted') || (+section1Values('home_value') - (+section5Values('mortgage_value_1') || 0))}</P.D>
              ...
              : <FinalizeChild className={'full'} order={1}>
                <FinalizeTable>
                  ...
                  <tr>
                    ...
                    <P.D as={'td'}>${+section7Values('amount_wanted') || (+section1Values('home_value') - (+section5Values('mortgage_value_1') || 0))}</P.D>
                  </tr>
                  <tr>
      ...
      <FormStep pageName={pageName} activeTheme={formData.section_9?.section_theme} stepName={formData.section_9?.section_name}>
        <div className="upload-step-wrapper">
          ...
          <FormConditionalInput name={'mortgages_1'} showOn={'yes'} checked={'yes'} {...formData.section_9?.have_appraisal_report_yes_no}>
            <FileInput label={formData.section_9?.appraisal_report_upload_label} acceptText={'PDF, JPG, or PNG'}/>
            <Appraiser>
      ...
      <FormStep pageName={pageName} activeTheme={formData.section_10?.section_theme} stepName={formData.section_10?.section_name}>
        <LastStep>
          ...
          <div style={{flexBasis: '20%'}} className="text">
            ...
            <p className={'form-headline-3'}>{formData.section_10?.subtitle}</p>
