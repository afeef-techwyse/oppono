    ...
    <Form endPoint={'/heloc'}>
      ...
      <FormStep apiStepNumber={2} pageName={pageName} activeTheme={formData.section_2?.section_theme} stepName={formData.section_2?.section_name}>
        ...
        <FormConditionalInput name={'have_mortgage_1'} showOn={'1'} checked={'0'} {...formData.section_2?.any_mortgage_yes_no}>
          <Input type={'text'} pattern={'[0-9]+'} name={'mortgage_value_1'} {...formData.section_2?.first_mortgage_amount_input}/>
        </FormConditionalInput>
  
        <FormConditionalInput name={'have_mortgage_2'} showOn={'1'} checked={'0'} {...formData.section_2?.second_mortgage_yes_no}>
          <Input type={'text'} pattern={'[0-9]+'} name={'mortgage_value_2'} {...formData.section_2?.second_mortgage_amount_input}/>
        </FormConditionalInput>
  
        <FormConditionalInput name={'have_outstanding_amount'} showOn={'1'} checked={'0'} {...formData.section_2?.outstanding_balance_yes_no}>
          <Input type={'text'} pattern={'[0-9]+'} name={'outstanding_amount_value'} {...formData.section_2?.outstanding_balance_amount_input}/>
        </FormConditionalInput>
      ...
      <FormStep sendSteps={[
        ...
        <div className="form-text-wrapper">
          <h1 className={'form-headline-1 primary'}>{formData.section_4?.qualify_for}</h1>
          <div className={'biggest-number'}><p><sup>$</sup>{+section2Values('home_value') - (+section2Values('mortgage_value_1') || 0)}</p></div>
        </div>
  
        <FormConditionalInput name={'confirm_qualify_amount'} showOn={'0'} checked={'0'}{...formData.section_4?.amount_like_yes_no}>
      ...
      <FormStep apiStepNumber={5} pageName={pageName} activeTheme={formData.section_5?.section_theme} stepName={formData.section_5?.section_name}>
        <div className="form-text-wrapper wide-text">
          ...
          <h2 className={'form-headline-3 primary'}>You are requesting a home equity line of credit against your {section1Values('property')}, {section1Values('property_details_1')} home which is
            located
        ...
        <Finalize>
          ...
          <Bottom>
            {media !== 'mobile'
              ? <FinalizeChild order={1}>
                <P.D>Your HELOC request is for ${section4Values('confirm_qualify_amount') === '0' ? +section4Values('amount_wanted') : mortgage}</P.D>
              ...
              : <FinalizeChild className={'full'} order={1}>
                <FinalizeTable>
                  ...
                  <tr>
                    ...
                    <P.D as={'td'}>${section4Values('confirm_qualify_amount') === '0' ? +section4Values('amount_wanted') : mortgage}</P.D>
                  </tr>
                  <tr>
