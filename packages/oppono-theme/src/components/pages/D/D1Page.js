...
const pageName = 'd-1';
const D1Page = ({className, state, actions}) => {
  ...
  const
    section1Values = getD1Values(formData.section_1?.section_name),
  ...
  return <div className={className}>
    <Form endPoint={'/refinance'}>
      ...
      <FormStep apiStepNumber={2} pageName={pageName} activeTheme={formData.section_2?.section_theme} stepName={formData.section_2?.section_name}>
        ...
        <Input type={'text'} pattern={'[0-9]+'} serverErrorMessage={state.theme.errors?.['home_value']} name={'home_value'} {...formData.section_2?.estimated_value_input}/>
        <RadioGroup radioText={formData.section_2?.appraisal_report_yes_no.label}>
          <RadioInput label={formData.section_2?.appraisal_report_yes_no.yes} value={'1'} serverErrorMessage={state.theme.errors?.['have_appraisal_report']} name={'have_appraisal_report'}
                      type={'radio'}/>
          <RadioInput label={formData.section_2?.appraisal_report_yes_no.no} value={'0'} serverErrorMessage={state.theme.errors?.['have_appraisal_report']} name={'have_appraisal_report'}
                      type={'radio'}/>
        </RadioGroup>
        ...
        <FormConditionalInput serverErrorMessage={state.theme.errors?.['have_mortgage_1']} name={'have_mortgage_1'} showOn={'1'} checked={'0'} {...formData.section_2?.any_mortgage_yes_no}>
          <Input type={'text'} pattern={'[0-9]+'} serverErrorMessage={state.theme.errors?.['mortgage_value_1']} name={'mortgage_value_1'} {...formData.section_2?.first_mortgage_amount_input}/>
        ...
        <FormConditionalInput serverErrorMessage={state.theme.errors?.['have_mortgage_2']} name={'have_mortgage_2'} showOn={'1'} checked={'0'} {...formData.section_2?.second_mortgage_yes_no}>
          <Input type={'text'} pattern={'[0-9]+'} serverErrorMessage={state.theme.errors?.['mortgage_value_2']} name={'mortgage_value_2'} {...formData.section_2?.second_mortgage_amount_input}/>
        </FormConditionalInput>
          ...
          <Bottom>
            {media !== 'mobile'
              ? <FinalizeChild order={1}>
                ...
                <P.D>Your down payment is ${+section2Values('home_value') - mortgage}</P.D>
              ...
              : <FinalizeChild className={'full'} order={1}>
                <FinalizeTable>
                  ...
                  <tr>
                    ...
                    <P.D as={'td'}>${+section2Values('home_value') - mortgage}</P.D></tr>
                  <tr>
