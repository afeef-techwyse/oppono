...
import {objectFilter} from '../../../functions/objectFilter';
import useStoredFormValue from '../../../hooks/useStoredFormValue';

const pageName = 'a-3';
const A3Page = ({state, actions, className}) => {
  ...
  const [section1Values, section2Values, section3Values, section4Values] = [getA3Values(formData.section_1?.section_name), getA3Values(formData.section_2?.section_name), getA3Values(formData.section_3?.section_name), getA3Values(formData.section_4?.section_name)];
  ...
  return <div className={className}>
    <Form>
      ...
      <FormStep pageName={pageName} activeTheme={formData.section_2?.section_theme} stepName={formData.section_2?.section_name}>
        ...
        <FormConditionalInput name={'have_mortgage_1'} showOn={'yes'} checked={'yes'} {...formData.section_2?.any_mortgage_yes_no}>
          <Input type={'number'} name={'mortgage_value_1'} {...formData.section_2?.first_mortgage_amount_input}/>
        </FormConditionalInput>
        
        <FormConditionalInput name={'have_mortgage_2'} showOn={'yes'} checked={'yes'} {...formData.section_2?.second_mortgage_yes_no}>
          <Input type={'number'} name={'mortgage_value_2'} {...formData.section_2?.second_mortgage_amount_input}/>
        </FormConditionalInput>
        
        <FormConditionalInput name={'have_outstanding_amount'} showOn={'yes'} checked={'yes'} {...formData.section_2?.outstanding_balance_yes_no}>
      ...
      <FormStep pageName={pageName} activeTheme={formData.section_4?.section_theme} stepName={formData.section_4?.section_name}>
        ...
        <div className="form-text-wrapper">
          <h1 className={'form-headline-1'}>{formData.section_4?.qualify_for}</h1>
          <div className={'biggest-number'}><p><sup>$</sup>{+section2Values('home_value') - (+section2Values('mortgage_value_1') || 0)}</p></div>
        </div>
        
        <FormConditionalInput name={'confirm_qualify_amount'} showOn={'no'} checked={'yes'}{...formData.section_4?.amount_like_yes_no}>
          <Input type={'text'} name={'amount_wanted'} {...formData.section_4?.amount_want_input}/>
        </FormConditionalInput>
      ...
      <FormStep pageName={pageName} activeTheme={formData.section_5?.section_theme} stepName={formData.section_5?.section_name}>
        <div className="form-text-wrapper wide-text">
          ...
          <h2 className={'form-headline-3'}>You are requesting a home equity line of credit against your {section1Values('property')}, {section1Values('property_details_1')} home which is located
        ...
        <Finalize>
          ...
          <Bottom>
            {media !== 'mobile'
              ? <FinalizeChild order={1}>
                <P.D>Your HELOC request is for ${+section4Values('amount_wanted') || (+section2Values('home_value') - (+section2Values('mortgage_value_1') || 0))}</P.D>
              ...
              : <FinalizeChild className={'full'} order={1}>
                <FinalizeTable>
                  ...
                  <tr>
                    ...
                    <P.D as={'td'}>${+section4Values('amount_wanted') || (+section2Values('home_value') - (+section2Values('mortgage_value_1') || 0))}</P.D>
                  </tr>
                  <tr>
