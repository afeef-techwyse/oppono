...
const A1Page = ({className, state, actions}) => {
  ...
  const [section1Values, section2Values, section3Values] = [getA1Values(formData.section_1?.section_name), getA1Values(formData.section_2?.section_name), getA1Values(formData.section_3?.section_name)];
          ...
          <Bottom>
            ...
            <FinalizeChild order={2} className={'full m-border'}>
              <FinalizeTable>
                <tbody>
                <tr>
                  <P.Border as={'td'}>Your mortgage request is ${+section2Values('mortgage_value_1') || 0}</P.Border>
                  <P.Border as={'td'}>Your property value is ${+section2Values('home_value')}</P.Border>
                </tr>
                </tbody>
              </FinalizeTable>
            </FinalizeChild>
            <FinalizeChild order={3} className={'wide m-pr-40'}>
              <P.Border>Your down payment is ${+section2Values('home_value') - (+section2Values('mortgage_value_1') || 0)}</P.Border>
              <P.Border>Your LTV is {(+section2Values('home_value') - (+section2Values('mortgage_value_1') || 0)) * 100}%</P.Border>
            </FinalizeChild>
          </Bottom>
        </Finalize>
        <div className="btn-group">
