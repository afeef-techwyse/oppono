...
const pageName = 'd-3';
const D3Page = ({state, setCurrentTheme, actions, className}) => {
    ...
    <Form setCurrentTheme={setCurrentTheme} endPoint={'/heloc'}>
      ...
      <FormStep sendSteps={[
        ...
        <div className="form-text-wrapper">
          ...
          <div className={'biggest-number'}><p><sup>$</sup>{numberWithCommas(+section2Values('home_value') - (+section2Values('mortgage_value_1') || 0))}</p></div>
        </div>
              ...
              : <FinalizeChild className={'full'} order={1}>
                <FinalizeTable>
                  ...
                  <tr>
                    ...
                    <P.D as={'td'}>${numberWithCommas(section4Values('confirm_qualify_amount') === '0' ? +section4Values('amount_wanted') : mortgage)}</P.D>
                  </tr>
                  <tr>
                    <P.Dark as={'td'}>Property Value</P.Dark>
                    <P.D as={'td'}>${numberWithCommas(+section2Values('home_value'))}</P.D>
                  </tr>
                  <tr>
