...
const pageName = 'd-1';
const D1Page = ({className, setCurrentTheme, state, actions}) => {
              ...
              : <FinalizeChild className={'full'} order={1}>
                <FinalizeTable>
                  ...
                  <tr>
                    ...
                    <P.D as={'td'}>{numberWithCommas(Math.round(+section2Values('home_value') * firstProduct.fields?.maximum_ltv / 100))}</P.D>
                  </tr>
                  <tr>
