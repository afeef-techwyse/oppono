  ...
  return (
      <div className={className}>
        <Form setCurrentTheme={setCurrentTheme} endPoint={'/contact'}>
          ...
          <FormStep pageName={pageName} activeTheme={pageData.section_1?.section_theme} stepName={pageData.section_1?.section_name}>
          ...
          <FormStep pageName={pageName} activeTheme={pageData.section_2?.section_theme} stepName={pageData.section_2?.section_name}>
            <LastStep>
              <img src={pageData.section_2?.image.url} alt={pageData.section_2?.image.alt}/>
              <div style={{flexBasis: '55%'}} className="text">
                <h1 className={'form-headline-1 text-left'}>{pageData.section_2?.title}</h1>
                <p className={'form-headline-3 primary'}>{pageData.section_2?.subtitle}</p>
                <Wysiwyg dangerouslySetInnerHTML={{__html: pageData.section_2?.steps}}/>
